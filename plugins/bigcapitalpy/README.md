# BigCapital Plugin# PDF2MD Plugin
...
- ✅ **Middleware Integration**: Seamless integration with Business-Plugin-Middleware- ✅ **API Client**: Robust client for PDF2MD document management system
